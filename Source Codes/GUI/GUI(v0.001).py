...
orig_img = Image.open("hexel_works.png")
...
register_container = tk.Frame(text_boxes, bg = "yellow")
...
add_info = tk.LabelFrame(root, text="Additional Information", bg = "white", padx=10, pady=10, bd=1, relief="solid")
...
status = tk.Label(root, textvariable = folder_path, bd=1, relief=tk.SUNKEN, anchor="w")
status.grid(row=5, column=0, sticky="we", padx=1, pady=1)
...
tk.Label(add_info, text="No. of Pages").grid(row=0, column=0, sticky="w")
